  ...
  return (
    <div>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 z-40 w-64 h-screen bg-gray-50 dark:bg-gray-800 transition-transform ease-in-out duration-300 ${
